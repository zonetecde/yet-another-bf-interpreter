import { t as tick } from "./scheduler.IZExxfgS.js";
import { w as writable } from "./index.EkDD9cK_.js";
...
const base = globalThis.__sveltekit_1e1qpo3?.base ?? "";
const assets = globalThis.__sveltekit_1e1qpo3?.assets ?? base;
const version = "1705496783345";
    ...
    if (hash2 !== void 0 && nonhash === strip_hash(location)) {
      ...
      if (current_hash === hash2) {
        ...
        if (hash2 === "" || hash2 === "top" && a.ownerDocument.getElementById("top") === null) {
          ...
          a.ownerDocument.getElementById(hash2)?.scrollIntoView();
        }
        return;
      }
